...
<div style="text-align:center;">
  <figure style="display: inline-block; text-align: center;">
    ...
    <figcaption>Unconditionally generated images from the CelebA model pre-trained on LFWPeople, produced using Exponential Moving Average during training.</figcaption>
  </figure>
