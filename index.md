...
<div style="text-align:center;">
  <figure style="display: inline-block; text-align: center;">
    ...
    <figcaption>Unconditionally generated images from the CelebA model pre-trained on LFWPeople after 57 epochs, produced using Exponential Moving Average during training.</figcaption>
  </figure>
